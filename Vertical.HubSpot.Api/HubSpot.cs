...
namespace Vertical.HubSpot.Api {
    ...
    public class HubSpot : IHubSpot {
        ...
        public HubSpot(IContactApi contacts, ICompanyApi companies, IAssociationApi associations, IDealsApi deals, ITicketsApi tickets, IEngagementsApi engagements) {
            Contacts = contacts;
            Companies = companies;
